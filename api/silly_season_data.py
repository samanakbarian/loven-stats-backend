SILLY_SEASON_BASELINE = {
    ...
    "confirmed_departures": [
        ...
        { "name": "Melwin Asp-Cassåsen", "number": None, "pos": "GK", "to": "Okänt", "date": "2026-04-29", "source": "bjorkloven.com", "note": "Andramålvakt, lämnar inför SHL" },
        ...
        { "name": "Tim Theocharidis", "number": None, "pos": "RD", "to": "Okänt", "date": "2026-04-29", "source": "bjorkloven.com", "note": "Följer inte med till SHL" },
    ...
    "rink_positions": {
        ...
        "defense_pairs": [
            ...
            { "ld": { "player": "Anton Malmström", "number": 64, "status": "FÖRLÄNGD" }, "rd": { "player": None, "status": "VAKANT", "rumors": ["SHL-förstärkning sökes"] } },
            { "ld": { "player": None, "status": "VAKANT", "rumors": ["Maione & Sjöström har lämnat", "Nyförvärv"] }, "rd": { "player": None, "status": "VAKANT", "rumors": ["Vainio→AIK, Nordsäter lämnar", "Nyförvärv"] } },
        ],
        "forward_lines": [
